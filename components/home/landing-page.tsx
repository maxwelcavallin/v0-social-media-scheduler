    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section id="features" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: CalendarDays, title: "Agendamento inteligente", desc: "Agende posts com antecedência no Instagram e Facebook. Calendário visual para organizar toda a estratégia." },
            { icon: Users, title: "Multi-workspace", desc: "Organize cada cliente em seu próprio workspace. Separe contas, posts e calendários por cliente." },
            { icon: Zap, title: "Publicação automática", desc: "Publique automaticamente no horário certo, sem precisar estar online. Foque na estratégia, não na execução." },
            { icon: Instagram, title: "Instagram completo", desc: "Posts de imagem, carrossel, Reels e Stories. Conecte qualquer conta profissional do Instagram." },
            { icon: Facebook, title: "Facebook Pages", desc: "Gerencie páginas do Facebook com posts, imagens e vídeos. Conecte múltiplas páginas em um workspace." },
            { icon: LayoutDashboard, title: "Dashboard unificado", desc: "Visualize todos os posts e clientes em um único painel. Filtros por status, data e plataforma." },
          ].map(({ icon: Icon, title, desc }) => (
            <div key={title} className="flex flex-col gap-4 p-6 rounded-xl border border-border bg-card">
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <p className="text-center text-muted-foreground mb-12">Comece grátis. Escale conforme seu negócio cresce.</p>
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          <div className="flex flex-col gap-6 p-8 rounded-xl border border-border bg-card">
            ...
            <Button variant="outline" asChild className="mt-auto"><Link href="/register">Começar grátis</Link></Button>
          </div>
          <div className="flex flex-col gap-6 p-8 rounded-xl border-2 border-primary bg-card relative">
            ...
            <Button asChild className="mt-auto"><Link href="/register">Começar agora</Link></Button>
          </div>
        </div>
      </section>
